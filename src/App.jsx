...
// --- Dashboard Component ---
const Dashboard = ({ team, records, season, setSeason }) => {
  ...
  const activeTargets = season === 'H1' ? RANK_TARGETS_H1 : RANK_TARGETS_H2;
          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-gray-50 text-sm">
              {stats.memberStats.map((member, index) => {
                ...
                const isDoubleEligibleRank = season === 'H2' && DOUBLE_AWARD_H2[member.role];
                const doubleTarget = isDoubleEligibleRank ? DOUBLE_AWARD_H2[member.role] : null;
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-gray-100">
                {Object.entries(DOUBLE_AWARD_H2).map(([role, val]) => (
                  <tr key={role}>
